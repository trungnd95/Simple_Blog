...
@section('body.header')
    <header class="intro-header" style="background-image: url({{asset('public/upload/images/'.$author->avatar)}})">
        <div class="container">
            <div class="row">
...
@section ('body.content')
        ...
        <div class="row">
            ...
            <div class="back_typesome">
                <p class="go-back"><a class="fa fa-long-arrow-left" href="{{route('index')}}"><span>Back</span></a></p>
            </div>
                @foreach($articles_user as $item)
